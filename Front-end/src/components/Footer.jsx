            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
                    ...
                    <div className="flex-1 order-2 md:order-1">
                        <p className="text-description text-sm tracking-wide">
                            © {currentYear} <span className="text-headline">{name}</span>. All Rights Reserved.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 order-1 md:order-2 flex justify-center">
                        <div className="flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/5 group transition-colors hover:border-primary/20">
                            <span className="text-description text-xs font-bold uppercase tracking-widest">Built with</span>
                            <FaHeart className="text-red-500 animate-pulse text-xs" />
                            <span className="text-description text-xs font-bold uppercase tracking-widest">by Master</span>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 order-3 flex justify-center md:justify-end">
                        <button
                            onClick={scrollToTop}
                            className="group flex items-center gap-3 text-description hover:text-primary transition-all duration-300 font-black text-[10px] uppercase tracking-[0.3em] cursor-pointer"
                        >
